...
#  ifndef JSON_USE_CPPTL_SMALLMAP
	  ...
	  typedef std::list<CZString> ObjectUnorderedNames;	///< unordered
#  else
...
# endif
      ...
      Members getMemberNames(bool bPreserveOrder) const;
...
# ifdef JSON_VALUE_USE_INTERNAL_MAP
		 ...
		 struct {
			ObjectValues *map_;
			ObjectUnorderedNames *map_names_;
		 } object;
# endif
      } value_;
      ValueType type_ : 8;
...
public: // overridden from ValueArrayAllocator
   ...
   public:
	  ...
	  ValueIteratorBase (const std :: map <Value::CZString, Value> :: iterator & current);
#else
